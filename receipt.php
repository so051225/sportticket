    ...
    <tbody>
        <tr>
            <td style="width: 205.55pt;padding: 0cm 5.4pt;height: 410.6pt;vertical-align: top;">
                ...
                <p style='margin:0cm;margin-bottom:.0001pt;font-size:16px;font-family:"Calibri","sans-serif";margin-left:1.7pt;'><span style="font-size:11px;font-family:標楷體;">取用設施時租用者須攜同收據及收據上登記其本人的運動易會員卡(正本)以便向工作人員取場，租用者必須為使用者之一，否則不獲取用設施。</span><span style='font-size:11px;font-family:"Times New Roman","serif";'><br>&nbsp;Para a utilização da instalação desportiva, o locatário deve munir-se e apresentar ao pessoal da respectiva instalação o recibo e o cartão de sócio (original) registado no recibo, devendo o qual ser um dos utentes da instalação desportiva, sob pena de não se poder utilizar a instalação.</span></p>
            </td>
        </tr>
    </tbody>
</table>
