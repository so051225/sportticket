...
/*
	...
	include_once('dao/site.php');
	include_once('dao/court.php');
	...
	class db {
		...
		function get_site_name_by_id($conn, 
	}
*/
...
class db{
	...
	public function __construct($dbhost = 'localhost', $dbuser = 'root', $dbpass = '', $dbname = '', $charset = 'utf8') {
		...
		$this->connection = new mysqli($config_db_host, $config_db_user, $config_db_pw, $config_db_name);
